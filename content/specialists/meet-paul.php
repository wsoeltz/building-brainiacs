<div class="row paul-tryon-founder">
	<div class="image"><img src="images/homepage/paul-tryon-profile.png" alt="Photo of Paul Tryon" title="Paul Tryon, Literary Tutoring Specialist"></div>
	<div class="text">
		<h5>Paul Tryon</h5>
		<h6>Founder</h6>
...
<div class="row">
	<h3 id="clickForPaulTryon"><a href="#">Learn more about our founder, Paul&nbsp;Tryon. <i class="fa fa-chevron-down" aria-hidden="true"></i></a></h3>
</div>
<div id="aboutPaulTryon" >
	<div class="row">
		<div class="image-column">
			<img src="images/paul-tryon-piano.jpg" alt="Paul Tryon playing the piano" title="In addition to tutoring, Paul Tryon loves playing the piano.">
		</div>
